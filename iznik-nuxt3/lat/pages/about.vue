...
/* Safety Section */
.safety-section {
  background-color: var(--lat-color-surface);
}
...
.rules-card {
  ...
  padding: 30px;
  border-radius: 8px;
  border-left: 4px solid var(--lat-color-primary);
}
...
/* primaryDark on #f0fde4 → 5.6:1 ✓ */
.trial-info h4 {
  color: var(--lat-color-primary-dark) !important;
}
